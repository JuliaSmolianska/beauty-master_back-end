...
const forgotPasswordEmail = (email, generatePassword) => ({
  ...
  html: `<p>${generatePassword}</p><br/><a target="_blank" href="https://juliasmolianska.github.io/beauty-master_front-end/login"><button>Перейти на сторінку входу</button></a>`
});
